        ...
        getCustomerListTable().find('tr').then((row) => {
            ...
            row.toArray().forEach((element) => {
                if (element.innerHTML.includes(usremail)) {
                    ...
                    getCustomerListTable().should('be.visible', true)
                    getCustomerListTable().find('tr').then((nrow) => {
                        ...
                        nrow.toArray().forEach((el) => {
                            if (el.innerHTML.includes(usremail)) {
                                ...
                                getCustomerListTable().find('tr').eq(nrow.index(element)).find('td').eq(0).then(function (coln) {
        ...
        getCustomerListTable().find('tr').then((row) => {
            ...
            row.toArray().forEach((element) => {
                if (element.innerHTML.includes(usremail)) {
                    ...
                    cy.wait(2000)
                    getCustomerListTable().should('be.visible', true)
                    getCustomerListTable().find('tr').then((xrow) => {
